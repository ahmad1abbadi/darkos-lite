...
def termux_pkg():
    ...
    os.system("pkg install wget libpng xorg-xrandr unzip p7zip patchelf -y --no-install-recommends &>/dev/null")
...
def scripts():
    ...
    os.system("mv darkos update-darkos.py darkos.py winetricks debug-darkos.py run-darkos.py cpu_boost.py photo.py $PREFIX/bin/")
def remove():
