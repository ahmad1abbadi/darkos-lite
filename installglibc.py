...
def create_prefix():
    ...
    if os.path.exists(f"/sdcard/darkos-savegames"):
        ...
        os.system(f'cd /sdcard/darkos-savegames/users/; if [ $(ls | grep "^u") != $(whoami) ]; then mv $(ls | grep "^u") $(whoami); fi;  cd - &>/dev/null')
...
def scripts():
    os.system("wget https://raw.githubusercontent.com/ahmad1abbadi/darkos-lite/updates/update-darkos.py &>/dev/null")
    os.system("wget https://raw.githubusercontent.com/ahmad1abbadi/darkos-lite/updates/debug-darkos.py &>/dev/null")
    os.system("wget https://raw.githubusercontent.com/ahmad1abbadi/darkos-lite/updates/photo.py &>/dev/null")
    os.system("wget https://raw.githubusercontent.com/ahmad1abbadi/darkos-lite/updates/darkos &>/dev/null")
    os.system("wget https://raw.githubusercontent.com/ahmad1abbadi/darkos-lite/updates/run-darkos.py &>/dev/null")
    os.system("wget https://raw.githubusercontent.com/ahmad1abbadi/darkos-lite/updates/darkos.py &>/dev/null")
    os.system("wget https://raw.githubusercontent.com/Winetricks/winetricks/master/src/winetricks &>/dev/null")
    os.system("wget https://raw.githubusercontent.com/ahmad1abbadi/darkos-lite/updates/cpu_boost.py &>/dev/null")
    os.system("wget https://raw.githubusercontent.com/ahmad1abbadi/darkos-lite/updates/file-selector &>/dev/null")
