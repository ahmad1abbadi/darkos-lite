...
def build_box64():
    ...
    print("")
    print("Remember to disable android phantom process killer following this steps before continue:")
    print("https://github.com/ahmad1abbadi/darkos-lite?tab=readme-ov-file#known-issues")
    print("")
